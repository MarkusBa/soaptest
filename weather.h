...
/* weather.h
   Generated by wsdl2h 2.8.21 from http://www.webservicex.net/globalweather.asmx?WSDL and typemap.dat
   2015-03-29 05:28:02 GMT
...
/// - soap_new__ns1__GetWeather(soap*) allocate
/// - soap_new__ns1__GetWeather(soap*, int num) allocate array
/// - soap_new_req__ns1__GetWeather(soap*, ...) allocate, set required members
/// - soap_new_set__ns1__GetWeather(soap*, ...) allocate, set all public members
...
/// - soap_new__ns1__GetWeatherResponse(soap*) allocate
/// - soap_new__ns1__GetWeatherResponse(soap*, int num) allocate array
/// - soap_new_req__ns1__GetWeatherResponse(soap*, ...) allocate, set required members
/// - soap_new_set__ns1__GetWeatherResponse(soap*, ...) allocate, set all public members
...
/// - soap_new__ns1__GetCitiesByCountry(soap*) allocate
/// - soap_new__ns1__GetCitiesByCountry(soap*, int num) allocate array
/// - soap_new_req__ns1__GetCitiesByCountry(soap*, ...) allocate, set required members
/// - soap_new_set__ns1__GetCitiesByCountry(soap*, ...) allocate, set all public members
...
/// - soap_new__ns1__GetCitiesByCountryResponse(soap*) allocate
/// - soap_new__ns1__GetCitiesByCountryResponse(soap*, int num) allocate array
/// - soap_new_req__ns1__GetCitiesByCountryResponse(soap*, ...) allocate, set required members
/// - soap_new_set__ns1__GetCitiesByCountryResponse(soap*, ...) allocate, set all public members
...
@section GlobalWeatherSoap_ports Endpoints of Binding "GlobalWeatherSoap"
...
C++ proxy class (defined in soapGlobalWeatherSoapProxy.h):
@code
  class GlobalWeatherSoapProxy;
@endcode
Important: use soapcpp2 option '-j' (or '-i') to generate improved and easy-to-use proxy classes;

C++ service class (defined in soapGlobalWeatherSoapService.h):
@code
...
@section ns1 Top-level root elements of schema "http://www.webserviceX.NET"
  ...
  - <GetWeather> @ref _ns1__GetWeather
    @code
  ...
  - <GetWeatherResponse> @ref _ns1__GetWeatherResponse
    @code
    // Reader (returns SOAP_OK on success):
  ...
  - <GetCitiesByCountry> @ref _ns1__GetCitiesByCountry
    @code
    // Reader (returns SOAP_OK on success):
  ...
  - <GetCitiesByCountryResponse> @ref _ns1__GetCitiesByCountryResponse
    @code
    // Reader (returns SOAP_OK on success):
